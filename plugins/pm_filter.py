    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('✌️ Hey Check PM {from_user.first_name} , I have sent files in pm \n\n',show_alert = True)
